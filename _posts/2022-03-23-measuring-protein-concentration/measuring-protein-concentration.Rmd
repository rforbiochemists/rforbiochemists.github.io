---
title: "Measuring Protein Concentration"
description: |
...
author:
  - name: Brady Johnston
    url: https://twitter.com/bradyajohnston
date: 2022-03-23
output:
...
How do we go about measuring protein concentration?
...
Under the hood it's just fitting linear models, pulling out relevant statistics and using them to predict values. All of this may seem easy if you are exerienced in R - but the intention of this package is to create a beginner-friendly and _reproducible_ API for doing common molecular biology tasks inside of R.
